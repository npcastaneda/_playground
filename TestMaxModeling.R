...
spID <- "Lathyrus_aphaca" #CAMBIAR POR UNA ESPECIE QUE QUIERAN PROBAR
OSys <- "NT"
inputDir <- "D:/CIAT_work/Gap_analysis/ICARDA-collab/lathyrus/maxent_modelling" #CAMBIAR EL PATH EN DONDE ESTAN LAS CARPETAS _SCRIPTS, BIOMOD_MODELING, ETC

theEntireProcess <- (spID, OSys, inputDir) 