# Parallelizing Code 008.sizeDR.R
# H. Achicanoy - 2013

src.dir <- "/home/haachicanoy/gap_sorghum/_scripts" # Directorio donde están los scripts
bdir,crop_dir    <- "/home/haachicanoy/gap_sorghum" # Directorio del cultivo
...
areasProcess <- function(bdir, ncpu){
	...
	sfExport("sizeDR")
	sfExport("summarizeDR")
	
	#run the control function
	system.time(sfSapply(as.vector(1:length(spList)), areas_wrapper))
